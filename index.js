...
var parcelUrl = 'http://www.spokanecounty.org/pubpadal/ParcelSummary.aspx';
var rootUrl = 'http://beyondthewhiteboard.com/gyms/2-main-site/calendar/?d=';
var previousMonth = '2015-08-01';

function getParselNumbers(){
    // visit the page
    request(parcelUrl, function (error, response, body) {
    ...
    // run search with valid viewstate stuff
...
//         var fullUrl = parselUrl + urls[loopIteration];
//         //console.log(fullUrl);
